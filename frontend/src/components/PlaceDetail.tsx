    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="absolute rounded-r-2xl border-gray-200 border-r z-[33333] left-0 inset-y-0 w-1/4 bg-white/50 backdrop-blur-lg"
        >
          <div className="overflow-y-auto h-full">
            <img
              src={image}
              className="w-full h-40 object-cover rounded-tr-2xl"
            />
